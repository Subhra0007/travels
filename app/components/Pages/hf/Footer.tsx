...
const Footer: React.FC = () => {
  return (
    <footer className="bg-[#061a23] text-gray-300 pt-12 pb-6">
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-10 border-b border-gray-700 pb-10">

        {/* Column 1 - About */}
        <div>
          <h2 className="text-white text-xl font-semibold mb-4">About Us</h2>
          <p className="text-sm leading-relaxed mb-4">
            We bring innovative solutions that help businesses achieve their goals with digital transformation and modern strategies.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm">
            <li className="flex items-center gap-2">
              <MdLocationOn className="text-cyan-400" /> Kolkata, India
            </li>
            <li className="flex items-center gap-2">
              <MdPhone className="text-cyan-400" /> +91 12345 98760
            </li>
            <li className="flex items-center gap-2">
              <MdEmail className="text-cyan-400" /> info@company.com
            </li>
          </ul>
        </div>
        ...
        <div>
         ...
         <form className="flex bg-white rounded-lg overflow-hidden w-full max-w-md">
  <input
    type="email"
  ...
  <button
    type="submit"
    className="w-1/3 bg-cyan-500 py-2 text-white font-semibold hover:bg-cyan-600 transition"
  >
    Subscribe
  </button>
</form>
