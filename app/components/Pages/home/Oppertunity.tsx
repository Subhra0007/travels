...
export default function AdventureSection() {
  return (
    <section className="bg-sky-50 pt-24  flex flex-col md:flex-row items-center justify-center gap-10">
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 lg:px-0 grid-cols-1">
        
      {/* Left Images */}
      <div className="flex gap-4 lg:flex-row flex-col justify-center items-center">
        <div className="grid gap-4">
        
          <div className="relative w-60 h-72  rounded-xl overflow-hidden shadow-lg">
            <Image
          ...
          <div className="bg-cyan-500 text-white rounded-xl flex items-center justify-center w-60 h-24 text-lg font-semibold shadow-md">
            Stories of Adventures
        </div>
      </div>
        <div className="relative w-80 h-100 rounded-xl overflow-hidden shadow-lg ">
          <Image
      ...
      <div className=" text-left relative">
        ...
        <p className="text-cyan-500 font-medium mb-2 lg:text-left text-center">Start Exploring</p>
